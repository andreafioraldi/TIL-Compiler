...
#define OP_POP 0x3c
#define OP_DUP 0x3d
#define OP_CLEAR 0x3e
#define OP_DECL_I8 0x3f
#define OP_DECL_U8 0x40
#define OP_DECL_I16 0x41
#define OP_DECL_U16 0x42
#define OP_DECL_I32 0x43
#define OP_DECL_U32 0x44
#define OP_DECL_I64 0x45
#define OP_DECL_U64 0x46
#define OP_DECL_F32 0x47
#define OP_DECL_F64 0x48
#define OP_DECL_VP 0x49
#define OP_DECL_PT 0x4a
#define OP_DECL_ST 0x4b
#define OP_DECL_E_ST 0x4c
#define OP_STORE 0x4d
#define OP_STORE_0 0x4e
#define OP_STORE_1 0x4f
#define OP_STORE_2 0x50
#define OP_STORE_3 0x51
#define OP_STORE_VAL 0x52
#define OP_STORE_VAL_0 0x53
#define OP_STORE_VAL_1 0x54
#define OP_STORE_VAL_2 0x55
#define OP_STORE_VAL_3 0x56
#define OP_SET_AT 0x57
#define OP_SET_AT_0 0x58
#define OP_SET_AT_1 0x59
#define OP_SET_AT_2 0x5a
#define OP_SET_AT_3 0x5b
#define OP_SET_AT_C 0x5c
#define OP_SET_FIELD 0x5d
#define OP_SET_FIELD_0 0x5e
#define OP_SET_FIELD_1 0x5f
#define OP_SET_FIELD_2 0x60
#define OP_SET_FIELD_3 0x61
#define OP_SET_PT_FIELD 0x62
#define OP_SET_PT_FIELD_0 0x63
#define OP_SET_PT_FIELD_1 0x64
#define OP_SET_PT_FIELD_2 0x65
#define OP_SET_PT_FIELD_3 0x66
#define OP_S_ALLOC 0x67
#define OP_S_ALLOC_C 0x68
#define OP_GC_ALLOC 0x69
#define OP_GC_ALLOC_C 0x6a
#define OP_GC_ATOM_ALLOC 0x6b
#define OP_GC_ATOM_ALLOC_C 0x6c
#define OP_CALL 0x6d
#define OP_N_CALL 0x6e
#define OP_E_CALL 0x6f
#define OP_EN_CALL 0x70
#define OP_RET 0x71
#define OP_RET_STD 0x72
#define OP_FUNC_AD 0x73
#define OP_E_FUNC_AD 0x74
#define OP_N_FUNC_AD 0x75
#define OP_EN_FUNC_AD 0x76
#define OP_CALL_PT 0x77
#define OP_VAL_ASSIGN 0x78
#define OP_SIZEOF 0x79
#define OP_SIZEOF_T 0x7a
#define OP_SIZEOF_T_MUL 0x7b
#define OP_MINUM 0x7c
#define OP_ADD 0x7d
#define OP_SUB 0x7e
#define OP_MUL 0x7f
#define OP_DIV 0x80
...
#define OP_GT 0x8f
#define OP_GE 0x90
#define OP_IS_NULL 0x91
#define OP_TO_BOOL 0x92
#define OP_TO_BOOL_N 0x93
#define OP_JMP 0x94
#define OP_JMP_IF 0x95
#define OP_JMP_IF_N 0x96
#define OP_LABEL 0x97
#define OP_CAST_I8 0x98
#define OP_CAST_U8 0x99
#define OP_CAST_I16 0x9a
#define OP_CAST_U16 0x9b
#define OP_CAST_I32 0x9c
#define OP_CAST_U32 0x9d
#define OP_CAST_I64 0x9e
#define OP_CAST_U64 0x9f
#define OP_CAST_F32 0xa0
#define OP_CAST_F64 0xa1
#define OP_CAST_VP 0xa2
#define OP_CAST_PT 0xa3
#define OP_CAST_ST 0xa4
#define OP_CAST_E_ST 0xa5
#define OP_ABORT 0xa6
